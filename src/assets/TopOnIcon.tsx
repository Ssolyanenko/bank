...
export const TopOnIcon: FC<IconProps> = ({ className }) => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M11.3333 10.919V8L6 12L11.3333 16V13.081H23.3333V10.919H11.3333Z" fill={colors.grayDark_6} />
    <path
    ...
    />
    <path d="M7 15H9V17H7V15Z" fill={colors.grayDark_6} />
  </svg>
);
